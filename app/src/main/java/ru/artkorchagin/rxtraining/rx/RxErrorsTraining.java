...
public class RxErrorsTraining {
     ...
     * defaultValue
     */
    Observable<Integer> handleErrorsWithDefaultValue(Observable<Integer> intObservable,
     ...
     */
    Observable<Integer> handleErrorsWithFallbackObservable(Observable<Integer> intObservable,
