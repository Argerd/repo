...
public class RxTransformingTraining {
    ...
    public Observable<String> transformIntToString(Observable<Integer> intObservable) {
        return intObservable.map(i -> Integer.toString(i));
    }
     ...
     */
    public Observable<GroupedObservable<Character, String>> distributeNamesByFirstLetter(
            Observable<String> namesObservable) {
        return namesObservable.groupBy(string -> string.toCharArray()[0]);
    }
