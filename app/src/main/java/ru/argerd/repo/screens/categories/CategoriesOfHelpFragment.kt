...
import ru.argerd.repo.adapters.AdapterCategories
import ru.argerd.repo.data.model.Category
import ru.argerd.repo.utils.CategoriesDecorator
...
class CategoriesOfHelpFragment : MvpAppCompatFragment(), CategoriesView {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        recyclerCategories.addItemDecoration(CategoriesDecorator(
    ...
    override fun showListOfCategories(list: List<Category>?) {
        ...
        adapter.listOfCategories = list ?: listOf()
